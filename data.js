...
const PRODUCTS = {
    ...
    earphone: {
        label: '🎧 耳机',
        products: {
            'AirPods Pro 3':      { chip:'Apple H3 + U2(充电盒)', anc:'主动降噪（大幅升级）', transparency:'自适应通透模式', sound:'定制高偏移驱动单元+高动态范围放大器', spatial:'个性化空间音频（头部追踪）', battery:'8h / 24h（含MagSafe充电盒）', charge:'USB-C / MagSafe / Qi2无线', waterproof:'IP57', bluetooth:'蓝牙5.4', weight:'5.55g', features:'对话感知 / 自适应音频 / 语音隔离 / 助听器功能', fit:'XS/S/M/L 四种硅胶耳塞', find:'查找网络 / 精确查找 / U2芯片', price:'¥1899' },
        ...
        verdicts: {
            'AirPods Pro 3': 'H3芯片+IP57+8小时续航+助听器功能，苹果生态最佳搭档。2025年发布。',
